...
def get_onion_layers(text, mode='inf late'):
    if mode == 'inflate':
        prompt = (
            "请将以下文本分为九层递进解析，以当代艺术常见作品阐述的方式，每一层都像身份错乱、假象与真相交织的当代艺术家，"
            "用极度装腔、学术、（存在主义、虚无主义、解构，原生家庭，社会平等，歧视，身份，这一类的各种艺术家的呼吁关注点随机选择，不限于这些你可以自己选择一些）不断递进，长度逐渐加长"
            "让内容越来越玄乎、装逼、复杂，结尾极度自嘲或荒谬。最后一行像是动画片瑞克和莫蒂里面的瑞克一样啥也不在乎的总结或者吐槽，或者是无耻之徒的弗兰克风格"
        ...
        prompt = (
            ...
            "第6层到第7层：每层减少字数（每层14字以内），内容可以逐渐胡说八道、用流行语、废话文学或空洞无物的网络热词；"
            "第8层：你自己用最短的话总结之前你说的1-7层文本，简单直白，直达本质，最好本质到最简单的1-10个字，大白话，和前面成反差；"
            "第九层：最短，彻底崩溃，直接写“没啥意义，和我吃烧烤去吧”或“没啥意义，快找我喝点”。"
